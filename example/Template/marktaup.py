#An example to create templates from continuous traces
# and mark their P or S arrivals
import math
import obspy.taup
import numpy as ny
import glob
...
#build_taup_model("mymodel.nd") # please provide your model
            ...
            while(i<len(arrivals) and dist < distmax):
                ...
                if((arr.name == 'P' or arr.name == 'p') and pi == 0):
                    ...
                    if bothps == 1:
                        ...
                        p.write('%s %5.2f %.6e/%.6e 1 P\n' % (tr.stats.station+'.'+tr.stats.channel,p_time,p_ray_param,p_hslowness))
                ...
                if((arr.name == 'S' or arr.name == 's') and si == 0):
                    ...
                    p.write('%s %5.2f %.6e/%.6e 2 S\n' % (tr.stats.station+'.'+tr.stats.channel,s_time,s_ray_param,s_hslowness))
                ...
                if(pi == 1 and si == 1):
                    ...
                    tr.write(os.path.join(template,tr.stats.station+'.'+tr.stats.channel),format='SAC')
                    break
